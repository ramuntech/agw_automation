...
public class GovernmentWideInitiativesTests extends BaseTest {
   ...
   /* @Test
    ...
    public void validateCategoryManagement() throws InterruptedException {
    ...
    public void validateSharedServices() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
    ...
    public void validateHiDefInitiative() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
    ...
    public void validatePeriodicTable() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
    ...
    public void validateAdditionalResources() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
